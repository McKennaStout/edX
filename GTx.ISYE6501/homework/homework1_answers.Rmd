...
```
<!-- ## 01/22/2026 Update: I recieved a 100 on this assignment! -->

## Question 2.1 Answer  
<!-- ## rmarkdown::render("edX/GTx.ISYE6501/homework/homework1_answers.Rmd") -->
...
```{r}
data <- read.table(
    "C:/Users/mstout/OneDrive - AANP/Documents/Workspace.MAIN/edX/GTx.ISYE6501/data/Homework1_ISYE6501/data 2.2/credit_card_data-headers.txt",
     header = TRUE
     )  
```
