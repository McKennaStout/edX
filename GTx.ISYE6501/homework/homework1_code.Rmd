...
Using the trained model, the intercept [𝑎0] was 0.08157559, meaning that the model slightly favors class [1], which we did see with the [72] false positives  
The remaining ten coefficients [𝑎n] were obtained directly from the support vectors. The one of note, [A9], was 1.0050221405, which is quite large! The next closest was [A15] which sits at 0.1064387167.  
...
But running that gave me what I wanted, a list of accuracy points for each k value, with `k= 15` being the highest accuracy, so I will select this as a reasonable choice for this assignment.
